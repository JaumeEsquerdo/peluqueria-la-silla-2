    ...
    <section className="Nosotros-body" id="nosotros">
      ...
      <div className="Nosotros-content">
        <div className="Nosotros-text">
          <p>
            SOMOS UN EQUIPO APASIONADO POR EL ARTE DEL CABELLO.
            <br />
            <br />
            Nos gusta el olor a navaja recién afilada, el sonido de las tijeras
            y el ritual de sentarte en la silla. Aquí cada corte refleja
            dedicación, precisión y respeto por el oficio.
            <br />
            <br />
            Un sitio donde puedes desconectar, charlar y sentirte como en casa.
            Porque una buena barbería no es solo un lugar, es una experiencia.
          </p>
        </div>
        ...
        <div className="Nosotros-text">
          <p>
            ...
            <br />
            <br />
            NOS GUSTA CONOCERTE, ENTENDER TU PERSONALIDAD Y HACER EL MEJOR CORTE
            PARA TI.
            <br />
            <br />
